...
import com.chumcraft.usefulwanderingtrader.configuration.miniblockConfiguration;

import java.util.ArrayList;

public class Miniblocks extends Heads{

    public Miniblocks(Configuration config) 
    {
        super(config);
        this.sectionname = "miniblocks";
        loadHeads();
    ...
    {
        ret.add(new Miniblock(section));
    }

    @Override
    protected Configuration headsConfig(){
        return new miniblockConfiguration();
    }
} 