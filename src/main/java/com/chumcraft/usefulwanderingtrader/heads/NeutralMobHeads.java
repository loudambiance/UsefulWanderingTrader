...
import com.chumcraft.usefulwanderingtrader.configuration.neutralmobConfiguration;
import com.chumcraft.usefulwanderingtrader.configuration.passivemobConfiguration;

import java.util.ArrayList;

public class NeutralMobHeads extends Heads {

    public NeutralMobHeads(Configuration config) 
    {
        super(config);
        this.sectionname = "neutralheads";
        loadHeads();
    ...
    {
        ret.add(new NeutralMobHead(section));
    }

    @Override
    protected Configuration headsConfig(){
        return new neutralmobConfiguration();
    }
}